...
```{r}
#Youtube API
api_key <- "AIzaSyAKRrREUZ9W46S6eXGpICKqb0SgOitS_vw"
...
refresh_token <- "fXQXFgijQ9ez5pgt0ZqRrQu1BPE4GTxK2m1W3e7yAKKDirzfpZUNZj5UTklZlaSo"
...
get_artists_by_social_index <- function(sort_by, limit = 100, offset = 1, recent_release_within = 99999999999999) {
  # Construct the API URL
  url <- paste0("https://api.chartmetric.com/api/artist/anr/by/social-index?sortBy=", sort_by,
                "&limit=", limit,
                "&offset=", offset,
...
client_id <- "9c1a455fbe7c4d99a45ad2f1789dd80c"
client_secret <- "21293fa04d9847c391e2d7420b760827"
